...
theme_pub = theme_bw() +
    theme(
        ...
        axis.line.x = element_line(color = 'black', size = .75/(72.27/25.4)),
        axis.line.y = element_line(color = 'black', size = .75/(72.27/25.4)),
        axis.ticks.length = unit(2, 'pt'),
        legend.background = element_blank(),
        legend.key = element_blank(),
        legend.key.size = unit(.25, "cm"),
        axis.ticks = element_line(color = 'black', size = .75/(72.27/25.4)),
